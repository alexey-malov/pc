# Лабораторная работа №5 — Применение многопоточности в сетевых приложениях

- [Лабораторная работа №5 — Применение многопоточности в сетевых приложениях](#лабораторная-работа-5--применение-многопоточности-в-сетевых-приложениях)
  - [Задания](#задания)
