# Лабораторная работа №8 — Асинхронное выполнение на корутинах

- [Лабораторная работа №8 — Асинхронное выполнение на корутинах](#лабораторная-работа-8--асинхронное-выполнение-на-корутинах)
  - [Задания](#задания)
...
Внимание, внутренний цикл (по главам книги) должен быть вынесен из `ListBookChapters` **в отдельную функцию**.
