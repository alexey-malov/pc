# Лабораторная работа №9 — Параллельные вычисления на видеокартах

- [Лабораторная работа №9 — Параллельные вычисления на видеокартах](#лабораторная-работа-9--параллельные-вычисления-на-видеокартах)
  - [Задания](#задания)
    ...
    - [Задание 2 — Параллельная сортировка данных на GPU — 50 баллов](#задание-2--параллельная-сортировка-данных-на-gpu--50-баллов)
      - [Вариант 1 — Битонная сортировка — 50 баллов](#вариант-1--битонная-сортировка--50-баллов)
      - [Вариант 2 — Radix Sort — 100 баллов](#вариант-2--radix-sort--100-баллов)
...
#### Вариант 1 — Битонная сортировка — 50 баллов
...
#### Вариант 2 — Radix Sort — 100 баллов

Напишите программу, выполняющую сортировку массива 32-битных целых чисел на GPU.
Для этого используйте алгоритм [Radix Sort](https://en.wikipedia.org/wiki/Radix_sort).
